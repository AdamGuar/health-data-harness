...
For normal coding tasks, act as a software engineering assistant. Keep changes scoped, follow the existing project style, and use documented npm scripts for validation where relevant.

Do not switch into health-analysis behavior just because the repository contains health tooling.
